...
import VideoBehavioralAnalyzer from '../components/VideoBehavioralAnalyzer';
...
const IntegratedLiveInterviewPage = () => {
  console.log('IntegratedLiveInterviewPage component initializing...');
  ...
  // Handle behavioral score updates
  const handleBehavioralUpdate = (scores) => {
  ...
  // Cleanup on unmount
  useEffect(() => {
    console.log('IntegratedLiveInterviewPage component mounted');
    return () => {
      console.log('IntegratedLiveInterviewPage component unmounting');
  ...
  return (
    <div className="fixed inset-0 bg-black z-50">
      ...
      <div className="absolute inset-0 flex flex-col z-20">
        ...
        {/* Behavioral Analysis Panel - Top Right */}
        <div className="absolute top-20 right-4 w-80 z-30">
          <VideoBehavioralAnalyzer 
            videoRef={videoRef}
            onAnalysisUpdate={handleBehavioralUpdate}
          />
        </div>
...
export default IntegratedLiveInterviewPage;